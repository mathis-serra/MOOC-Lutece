...
('PROJECT_MANAGEMENT','examplemse.adminFeature.ManageProject.name',1,'jsp/admin/plugins/examplemse/ManageProjects.jsp','examplemse.adminFeature.ManageProject.description',0,'examplemse',NULL,NULL,NULL,4);
